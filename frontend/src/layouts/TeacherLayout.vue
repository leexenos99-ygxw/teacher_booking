  ...
  <el-container class="layout-container">
    <el-aside width="240px" class="sidebar">
      ...
      >
        ...
        <el-menu-item index="/teacher/calendar">
          <el-icon><Calendar /></el-icon>
          <span>时间管理</span>
        </el-menu-item>
        <el-menu-item index="/teacher/appointments">
...
import { ChatLineSquare, Monitor, Calendar, Tickets, User, Bell, ArrowDown } from '@element-plus/icons-vue'
